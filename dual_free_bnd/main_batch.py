...
if __name__ == "__main__":
    ...
    parser.add_argument("-dist", "--distortion", type=str, choices=["none", "lscm", "shear", "iso"], default="none", \
    ...
    with open(f"output/report{args.report_name}.csv", 'w', newline='') as csvfile:
        writer = csv.DictWriter(csvfile, fieldnames=["model", "energy", "time", "triangles", "conformal", "authalic", "det", "iso", "shear", "stretch_max", "stretch_mean"])
        writer.writeheader()
